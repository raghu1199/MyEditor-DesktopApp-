...
# user_submission_tracker = defaultdict(list)
# RATE_LIMIT = 5            # max submissions allowed
...
#         # 🔹 --- RATE LIMIT CHECK ---
#         now = time.time()
#         timestamps = user_submission_tracker[student_id]

#         # Remove old submissions outside the window
#         user_submission_tracker[student_id] = [
#             t for t in timestamps if now - t < WINDOW_SECONDS
#         ]

#         if len(user_submission_tracker[student_id]) >= RATE_LIMIT:
#             return jsonify({
#                 "error": "⚠️ Too many submissions. Please wait before trying again."
#             }), 429

#         # Record this submission
#         user_submission_tracker[student_id].append(now)
