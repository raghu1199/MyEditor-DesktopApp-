...
initTopbar() {
  ...
  newFileTypeMenu.addEventListener('click', async (e) => {
    ...
    if (this.currentFolderPath) {
      ...
      // filePath = path.join(this.currentFolderPath, newName);
    } else {
...
//     outputArea.innerText = '⚠️ Only JavaScript files can be run.';
//     return;
//   }

//   try {
//     outputArea.innerText = '⏳ Running...';
//     const result = await window.electronAPI.runJSFile(code);
//     outputArea.innerText = result;
//   } catch (err) {
//     outputArea.innerText = `❌ Failed to execute:\n${err.message}`;
//   }
// }
