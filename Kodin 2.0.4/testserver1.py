...
#     if not all([college, student_id]):
#         return jsonify({"error": "Missing params"}), 400

#     college_ref = firestore_client.collection(college)
#     result = []

#     # 🔥 Iterate all faculties under the college
#     faculties = college_ref.stream()
...
#         # 🔥 Iterate all subjects under this faculty
#         subjects = faculty_ref.collections()

#         for subject_coll in subjects:
#             subject = subject_coll.id

            

#             # 🔥 Path where we check student's status
#             req_ref = (
#                 faculty_ref
#                 .collection(subject)
#                 .document("requests")
...
#             # Check if student is part of this subject AND approved
#             if req_doc.exists:
#                 data = req_doc.to_dict() or {}
